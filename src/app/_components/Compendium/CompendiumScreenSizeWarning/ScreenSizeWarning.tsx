...
import rotateIcon from "../../../../../public/icons/phone-rotate/rotate.png";
import phoneIcon from "../../../../../public/icons/phone-rotate/phone.png";
import mouse from "../../../../../public/icons/screen-size-increase/mouse.png";
import urlline from "../../../../../public/icons/screen-size-increase/urlline.png";
import screenpng from "../../../../../public/icons/screen-size-increase/screen.png";
  ...
  return (
    <div className={styles["ssw__container"]}>
      <div className={styles["ssw__warning"]}>
        ...
        <Link href="/" className={styles["ssw__back"]}>
          go back to 20vt.help
        </Link>
        ...
        <div className={styles["ssw__demo"]}>
          ...
          <div className={styles["ssw__demo-container"]}>
            <div className={styles["increase-screensize"]}>
              <img src={mouse.src} className={styles["ss__mouse"]} />
              <img src={urlline.src} className={styles["ss__urlline"]}></img>
              {/* <img src={buttonsHttp} className={styles["ss__buttons"]}></img> */}
              <img src={screenpng.src} className={styles["ss__screen"]}></img>
            </div>
          </div>
        </div>
      </div>
