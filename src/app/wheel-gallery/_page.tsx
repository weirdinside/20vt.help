...
// actions
import { paginatedFetch } from "./actions";
...
import AboutModal from "../_components/Wheel Gallery/AboutModal/AboutModal";

export default function WheelGalleryContent({
  possibleFilters,
}: {
  possibleFilters: FilterOptions;
}) {
  // ---------------------------------------- //
    ...
    <div className={styles["page"]}>
      ...
      <main className={styles["main"]}>
        <section className={styles["wheelfinder"]}>
          <form
            style={hideFilters ? { maxHeight: "0vh" } : { maxHeight: "100vh" }}
            className={styles["wheelfinder__selector"]}
          >
            <CheckboxSection
              key={1}
              arrayName={"car_type"}
